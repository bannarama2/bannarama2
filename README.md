...
Solo Unity developer and incoming **MSc Games Technology** student at Coventry University (Sept 2026), building toward a career in **gameplay and graphics programming**.
...
### 🔭 Software Raytracer & Rasterizer (C# / .NET)
A from-scratch rendering pipeline with zero engine or graphics API dependencies. Implements:
